...
namespace DataTables.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var item = (from d in db.Products
                        select d).ToList();
            return View(item);
        ...
        public ActionResult Create([Bind(Include = "Id,productName,productImage,productQuantity")] Product product, HttpPostedFileBase image1)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,productName,productImage,productQuantity")] Product product)
        {
            if (ModelState.IsValid)
            {
